...
export default function HeroProjects({ post }) {
  ...
  const title = formatText(limitWords(post?.title?.rendered || "Projects", 10));
  const description = post?.acf?.tagline || "";

  return (
    <motion.section
      className="row mainbanner project-single-banner"
    ...
    >
      <div className="col-sm-8">
        ...
        <AnimatedParagraph text={description || " "} className="hero-desc" />
