...
import { fetchawardsPagePosts, selectawardsPagePosts, selectawardsPageLoading } from "@/store/slices/AwardsPageSlice";
...
export default function AwardBanner() {
  ...
  const awards = posts[0];
  const bgImage = awards?.featured_image;
  const title = awards?.title?.rendered || "Awards";
  const description =
    awards?.acf?.main_description || "Every space we design carries memory forward — alive with meaning.";
