...
export default function CareerBanner() {
  ...
  const career = posts[0];
  const bgImage = career?.featured_image;
  const title = career?.title?.rendered || "Careers";
  const description =
    career?.acf?.main_description || "Every space we design carries memory forward — alive with meaning.";
